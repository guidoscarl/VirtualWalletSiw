                    ...
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Custodisci il tuo denaro! Nessuno potrà toccarlo se non te. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-5 offset-lg-1 text">
                    ...
                    <p>Il portafoglio virtuale è nato per conservare in totale sicurezza il proprio denaro e fare in modo che solo il proprietario potrà accedervi e scambiarlo con chi vuole lui!</p>
                </div>
