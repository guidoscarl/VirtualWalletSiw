...
<head>
    ...
    <title>User Profile - Recharge</title>
	...
	<section class="portfolio-block">
        <div class="container">
            ...
            <form style="background-color:white" method="post" action="recharge" >
                ...
                <div class="form-group"><label for="name">Amount</label><input class="form-control" type="text" name="importo" id="importo"></div>
				<div class="button"><button class="btn btn-primary btn-block" type="button" onclick="makeRecharge();">Make recharge</button></div>
				<div class="form-group">
        			<p style="color:red;font-size:1.20vw;visibility:hidden;" id="error">Wrong username or password.</p>
        		</div>
        	</form>
        </div>
    </section>
